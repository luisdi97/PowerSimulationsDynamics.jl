"""
Test for PSS model : PSS2C available in PSS/e
This case study defines a two bus system with a GENROU machine in bus 1
and an infinite bus in 2.
The GENROU machine has the SEXS and the PSS2C models.
...
csv_file = joinpath(TEST_FILES_DIR, "benchmarks/psse/PSS2C/results_PSSe.csv")
...
@testset "Test 52 PSS2C ResidualModel" begin
    path = joinpath(pwd(), "test-psse-pss2c")
